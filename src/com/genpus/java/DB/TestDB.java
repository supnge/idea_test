package com.genpus.java.DB;

import java.sql.*;

/**
 * @author supeng/ supeng87@126.com
 * @date 2019-04-14 23:30
 * @Modified By:
 * @Description:
 */
public class TestDB {
    public static void main(String[] args) {
        ...
        // 数据库执行的语句
        String sql = "INSERT INTO `mysql`.`student` (`xuehao`, `xingming`, `kaoshenghao`, `zhucehao`, `shouji`, `dianhua`, `chushengriqi`) VALUES ('17641034310000', 'hello', '17W110013009999', '17W131001300001123', '18695531962', '18695531962', '1987-10-06');"; //插入一条记录
        ...
        try {
            ...
            while (rs.next()) { // 循环读取结果数据集中的所有记录
                System.out.println(rs.getRow() + "、 学号:" + rs.getString("xuehao").toString()
                        + "\t姓名:" + rs.getString("xingming").toString() + "\t考生号:"
                        + rs.getString("kaoshenghao"));
            }
